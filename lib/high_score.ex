defmodule HighScore do
  ...
  @spec add_player(map(), String.t(), non_neg_integer()) :: map()
  ...
  def reset_score(scores, name), do: scores |> remove_player(name) |> add_player(name)

  @spec update_score(map(), String.t(), non_neg_integer) :: map()
  def update_score(scores, name, new_score),
    do: Map.update(scores, name, new_score, fn existing_score -> existing_score + new_score end)
